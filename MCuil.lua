...
local Window = Library.CreateLib("MCuil", "RJTheme3")

SchemeColor = Color3.fromRGB(41, 229, 224)
...
Section:NewButton("Energize GUI:R6 Better", "ButtonInfo", function()
    --[[
	WARNING: Heads up! This script has not been verified by ScriptBlox. Use at your own risk!
]]
...
local Tab = Window:NewTab("P+")

local Section = Tab:NewSection("Pluse+")

Section:NewButton("Orca x", "ButtonInfo", function()
...
Section:NewButton("discord.gg/wem4X6cf7g", "ButtonInfo", function()
       print("discord.gg/wem4X6cf7g")
end)
